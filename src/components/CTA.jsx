      ...
      <div className="container-page flex flex-col items-start justify-between gap-6 py-16 sm:flex-row sm:items-center">
        <div>
          <h2 className="font-display text-2xl font-semibold sm:text-3xl">
            Faça o geoespacial trabalhar a seu favor.
          </h2>
          <p className="mt-2 max-w-md text-white/85">
            Trazemos uma perspectiva geoespacial para o seu negócio e
            desenvolvemos pipelines, análises e sistemas com visibilidade real
            sobre sua operação.
          </p>
        </div>
        <a
