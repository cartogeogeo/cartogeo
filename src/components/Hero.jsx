    ...
    <section id="topo" className="relative overflow-hidden bg-ink text-white">
      ...
      <div className="container-page relative py-24 sm:py-32">
        <div className="flex items-center gap-3 text-white/70">
          ...
          <span className="font-mono text-xs uppercase tracking-[0.18em]">CartoGeo | Cartografia, Geodésia e Geotecnologias </span>
        </div>

        <h1 className="mt-6 max-w-3xl font-display text-4xl font-semibold leading-tight sm:text-5xl md:text-6xl">
          Inteligência Geográfica para Decisões Críticas
        </h1>

        <p className="mt-6 max-w-xl text-base text-white/75 sm:text-lg">
          Consultoria especializada em Cartografia Digital, Geodésia e Geotecnologias. 
          Há mais de 30 anos transformamos dados geoespaciais em respostas precisas e juridicamente fundamentadas para governos, empresas e comunidades.
        </p>
