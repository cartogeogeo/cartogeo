      ...
      <div className="container-page grid gap-12 py-16 sm:grid-cols-2 lg:grid-cols-[1.3fr,0.9fr,0.7fr,0.7fr,0.7fr]">
        <div>
          ...
          <div className="mt-6 flex gap-4">
            <a href="https://br.linkedin.com/company/cartogeo-org?trk=public_post_follow-view-profile" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-white/60 hover:text-white">
              in
            </a>
            <a href="https://www.instagram.com/cartogeo_org?stkn=MW80bjUxb2x6cm1tZA==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/60 hover:text-white">
              ig
            </a>
            <a href="https://www.youtube.com/@cartogeo_org" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/60 hover:text-white">
              yt
            </a>
          </div>
        </div>
